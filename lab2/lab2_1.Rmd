...
The mean could not be calculated given the missing data value. Working with missing data values will likely pose a challenge, but there will likely be a way to bypass this.
...
```
This allowed us to omit the missing value and proceed to calculating the mean with all known values.
